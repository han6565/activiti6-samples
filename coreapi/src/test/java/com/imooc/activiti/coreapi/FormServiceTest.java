...
public class FormServiceTest {
    ...
    public void TestFormServcie(){
        ...
        HashMap<String, String> propertes1 = Maps.newHashMap();
        propertes1.put("yesORno","yes");
        formService.submitTaskFormData(task.getId(),propertes1);
